...
**If found:**
1. Read validation template from `/Users/markalston/.claude/get-shit-done/templates/VALIDATION.md`
...
```bash
node /Users/markalston/.claude/get-shit-done/bin/gsd-tools.cjs commit-docs "docs(phase-${PHASE}): add validation strategy"
```
...
```
Task(
  prompt="First, read /Users/markalston/.claude/agents/gsd-planner.md for your role and instructions.\n\n" + filled_prompt,
  subagent_type="general-purpose",
  model="{planner_model}",
...
Task(
  prompt="
    ...
    @/Users/markalston/.claude/get-shit-done/references/model-profile-resolution.md
    </execution_context>
