...
```bash
TRANSITION=$(node "/Users/markalston/.claude/get-shit-done/bin/gsd-tools.cjs" phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node "/Users/markalston/.claude/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
node "/Users/markalston/.claude/get-shit-done/bin/gsd-tools.cjs" config-set workflow._auto_chain_active false
```
