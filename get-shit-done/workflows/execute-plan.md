...
See `/Users/markalston/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
</tdd_plan_execution>
...
See /Users/markalston/.claude/get-shit-done/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `/Users/markalston/.claude/get-shit-done/templates/user-setup.md`.
...
Use /Users/markalston/.claude/get-shit-done/templates/summary.md for structure.
