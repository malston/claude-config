...
<!-- For checkpoint task examples and patterns, see @/Users/markalston/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/markalston/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/markalston/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
